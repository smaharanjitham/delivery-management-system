...
const models: TsoaRoute.Models = {
    ...
    "SaveFcmTokenRequestDto": {
        ...
        "properties": {
            ...
            "fcm_token": {"dataType":"string","required":true},
    ...
    "RecentOrderDto": {
        ...
        "properties": {
            ...
            "delivery_address": {"dataType":"string","required":true},
            "delivery_latitude": {"dataType":"double"},
            "delivery_longitude": {"dataType":"double"},
    ...
    "DashboardResponseDto": {
        ...
        "properties": {
            "success": {"dataType":"boolean","required":true},
            "message": {"dataType":"string","required":true},
            "summary": {"ref":"DashboardSummaryDto","required":true},
            "recentOrders": {"dataType":"array","array":{"dataType":"refObject","ref":"RecentOrderDto"},"required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        const argsFcmTokenController_saveToken: Record<string, TsoaRoute.ParameterSchema> = {
                body: {"in":"body","name":"body","required":true,"ref":"SaveFcmTokenRequestDto"},
        };
        app.post('/fcm-token/save',
            authenticateMiddleware([{"BearerAuth":[]}]),
            ...(fetchMiddlewares<RequestHandler>(FcmTokenController)),
            ...(fetchMiddlewares<RequestHandler>(FcmTokenController.prototype.saveToken)),

            async function FcmTokenController_saveToken(request: ExRequest, response: ExResponse, next: any) {

            // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa

            let validatedArgs: any[] = [];
            try {
                validatedArgs = templateService.getValidatedArgs({ args: argsFcmTokenController_saveToken, request, response });
        ...
        const argsAuthController_logout: Record<string, TsoaRoute.ParameterSchema> = {
                body: {"in":"body","name":"body","required":true,"ref":"LogoutRequestDto"},
        };
